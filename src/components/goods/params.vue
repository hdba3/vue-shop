    ...
    <div class="params">
        ...
        <el-card>
            ...
            <el-row class="cat_opt">
                <span>选择商品分类: </span>
                <!-- 级联选择框 -->
                <el-cascader v-model="selectdCateKeys" :options="cataList"
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="动态参数" name="many">
                    <el-button type="primary" @click="addDialogVisible = true" size="mini"
                    ...
                    <el-table :data="manyTableData" border stripe>
                        ...
                        <el-table-column label="操作">
                            <template v-slot="scope">
                                <el-button type="primary" @click="showEditDialog(scope.row.attr_id)" icon="el-icon-edit"
                                    size="mini">编辑</el-button>
                                <el-button type="danger" @click="removeParams(scope.row.attr_id)" icon="el-icon-delete"
